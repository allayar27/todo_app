<x-app-layout>
    <x-slot name="header">
        <nav class="navbar navbar-light bg-light">
            <div class="container">
                <a href="/"><span class="navbar-brand mb-0 h1">Edit Role</span></a>
                    ...
                    <section>
                        ...
                        @method('PUT')
                            <div>
                                ...
                                <x-text-input id="name" value="{{ $role->name }}" name="name" type="text" class="mt-1 block w-full" placeholder="role name" />
